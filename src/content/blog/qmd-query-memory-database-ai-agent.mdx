...
- **Hot Tier** (platform auto-inject): Core identity saja (kurang dari 500 chars). Nama, role, timezone, key principles.
...
qmd_context.py "<pesan>" → Query Warm + Deep
    ↓
Merge context relevan (maks 1500 chars)
    ↓
AI merespons
    ↓
...
- Budget maks 500 chars per record ✅ (177 + 225 chars)
...
- Output maks 1500 chars ✅ (actual: 388 chars avg)
